...
class NGPradianceField(torch.nn.Module):
    ...
    def __init__(
        ...
        spatial_density_bias: bool = False,
    ) -> None:
        super().__init__()
        ...
        self.spatial_density_bias = spatial_density_bias
    ...
    def query_density(self, x, return_feat: bool = False):
        ...
        x = (
            self.mlp_base(self.encoder(x.view(-1, self.num_dim)))
        ...
        if self.spatial_density_bias:
            density_before_activation = density_before_activation + 5 * torch.exp( - torch.sum(positions ** 2, dim=-1) / 0.04)[..., None]
